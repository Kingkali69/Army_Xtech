#!/bin/bash
# NEXUS Engine Launcher - CPU Optimized for Consumer Hardware

cd "/home/kali/Desktop/MITEL/Mitel-main"

echo "╔══════════════════════════════════════════════════════════════╗"
echo "║              🚀 NEXUS ENGINE CPU OPTIMIZED                    ║"
echo "║                                                              ║"
echo "║  🔥 KILLING ALL PROCESSES FIRST                              ║"
echo "║  🧠 Starting NEXUS Container                                 ║"
echo "║  🔌 USB Event Monitoring (3s interval)                      ║"
echo "║  🛡️  M.I.T.E.L. Zero-Trust Security                            ║"
echo "║  🌐 Auto-Opening Browser                                     ║"
echo "║  📱 Console Updates (5s interval)                           ║"
echo "║  💻 CPU Optimized for Ryzen 9                                ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
...
# Start M.I.T.E.L. with USB monitoring (background) - SLOW SCAN
echo "🛡️  Starting M.I.T.E.L. with USB monitoring (3s interval)..."
python3 -c "
from substrate.mitel_subsystem import MITELSubsystem
config = {'zero_trust': True, 'quarantine_unknown': True, 'scan_interval': 3.0}
mitel = MITELSubsystem(config)

if mitel.start():
    print('✅ M.I.T.E.L. started with USB event monitoring')
    print('🔌 USB devices will be detected every 3 seconds')
else:
...
echo "   🔄 Console updates: 5 seconds"
echo "   🔌 USB scanning: 3 seconds"
echo "   🧠 UI sync: 3 seconds"
echo "   📱 Event processing: 1 second"
echo ""
...
echo ""
echo "💻 CPU Usage should be normal on Ryzen 9"
...
while true; do
    ...
    echo ""
    echo "🔌 USB devices will be detected every 3 seconds"
    echo "💻 CPU should be normal on Ryzen 9"
    echo "🛑 Press Ctrl+C to stop everything"
    echo ""
    sleep 10  # Slower monitoring to save CPU
done
